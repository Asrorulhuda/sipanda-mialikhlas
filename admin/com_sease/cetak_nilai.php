...
// Fetch siswa and schema from admin global perspective
...
<body onload="window.print()">
    <div class="header">
        <?php if($logo_kiri): ?><img src="<?= $logo_kiri ?>" class="logo" alt="Logo Kiri"><?php else: ?><div class="logo"></div><?php endif; ?>
        <div class="kop-teks">
        ...
        <?php if($logo_kanan): ?><img src="<?= $logo_kanan ?>" class="logo" alt="Logo Kanan"><?php else: ?><div class="logo"></div><?php endif; ?>
    </div>
    ...
    <table class="meta-table">
        ...
        <tr>
            <td><strong>Administrator</strong></td><td>:</td><td><?= clean($_SESSION['nama']) ?></td>
            <td></td><td></td><td></td>
        </tr>
    </table>
    ...
    <div class="footer">
        <div class="ttd">
            <p>Mengetahui,</p>
            <p style="margin-bottom:60px;"><strong>Administrator Akademik</strong></p>
